...
#define GPT_ENT_TYPE_UNUSED                                                                                            \
  (const efi_guid_t) {                                                                                                 \
    le32(0x00000000), le16(0x0000), le16(0x0000), 0x00, 0x00, {                                                        \
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00                                                                               \
    }                                                                                                                  \
  }
#define GPT_ENT_TYPE_EFI                                                                                               \
  (const efi_guid_t) {                                                                                                 \
    le32(0xc12a7328), le16(0xf81f), le16(0x11d2), 0xba, 0x4b, {                                                        \
...
#define GPT_ENT_TYPE_EBP                                                                                               \
  (const efi_guid_t) {                                                                                                 \
    le32(0xbc13c2ff), le16(0x59e6), le16(0x4262), 0xa3, 0x52, {                                                        \
      0xb2, 0x75, 0xfd, 0x6f, 0x71, 0x72                                                                               \
    }                                                                                                                  \
  }
#define GPT_ENT_TYPE_MBR                                                                                               \
  (const efi_guid_t) {                                                                                                 \
    le32(0x024dee41), le16(0x33e7), le16(0x11d3), 0x9d, 0x69, {                                                        \
      0x00, 0x08, 0xc7, 0x81, 0xf3, 0x9f                                                                               \
    }                                                                                                                  \
  }
#define GPT_ENT_TYPE_FREEBSD                                                                                           \
  (const efi_guid_t) {                                                                                                 \
    le32(0x516e7cb4), le16(0x6ecf), le16(0x11d6), 0x8f, 0xf8, {                                                        \
      0x00, 0x02, 0x2d, 0x09, 0x71, 0x2b                                                                               \
    }                                                                                                                  \
  }
#define GPT_ENT_TYPE_FREEBSD_SWAP                                                                                      \
  (const efi_guid_t) {                                                                                                 \
    le32(0x516e7cb5), le16(0x6ecf), le16(0x11d6), 0x8f, 0xf8, {                                                        \
      0x00, 0x02, 0x2d, 0x09, 0x71, 0x2b                                                                               \
    }                                                                                                                  \
  }
#define GPT_ENT_TYPE_FREEBSD_UFS                                                                                       \
  (const efi_guid_t) {                                                                                                 \
    le32(0x516e7cb6), le16(0x6ecf), le16(0x11d6), 0x8f, 0xf8, {                                                        \
      0x00, 0x02, 0x2d, 0x09, 0x71, 0x2b                                                                               \
    }                                                                                                                  \
  }
#define GPT_ENT_TYPE_FREEBSD_ZFS                                                                                       \
  (const efi_guid_t) {                                                                                                 \
    le32(0x516e7cb), le16(0x6ecf), le16(0x11d6), 0x8f, 0xf8, {                                                         \
      0x00, 0x02, 0x2d, 0x09, 0x71, 0x2b                                                                               \
    }                                                                                                                  \
  }
/*
...
#define GPT_ENT_TYPE_FREEBSD_VINUM                                                                                     \
  (const efi_guid_t) {                                                                                                 \
    le32(0x516e7cb8), le16(0x6ecf), le16(0x11d6), 0x8f, 0xf8, {                                                        \
      0x00, 0x02, 0x2d, 0x09, 0x71, 0x2b                                                                               \
    }                                                                                                                  \
  }
...
#define GPT_ENT_TYPE_MS_BASIC_DATA                                                                                     \
  (const efi_guid_t) {                                                                                                 \
    le32(0xebd0a0a2), le16(0xb9e5), le16(0x4433), 0x87, 0xc0, {                                                        \
      0x68, 0xb6, 0xb7, 0x26, 0x99, 0xc7                                                                               \
    }                                                                                                                  \
  }
#define GPT_ENT_TYPE_MS_LDM_DATA                                                                                       \
  (const efi_guid_t) {                                                                                                 \
    le32(0xaf9b60a0), le16(0x1431), le16(0x4f62), 0xbc, 0x68, {                                                        \
      0x33, 0x11, 0x71, 0x4a, 0x69, 0xad                                                                               \
    }                                                                                                                  \
  }
#define GPT_ENT_TYPE_MS_LDM_METADATA                                                                                   \
  (const efi_guid_t) {                                                                                                 \
    le32(0x5808c8aa), le16(0x7e8f), le16(0x42e0), 0x85, 0xd2, {                                                        \
      0xe1, 0xe9, 0x04, 0x34, 0xcf, 0xb3                                                                               \
    }                                                                                                                  \
  }
#define GPT_ENT_TYPE_MS_RECOVERY                                                                                       \
  (const efi_guid_t) {                                                                                                 \
    le32(0xde94bba4), le16(0x06d1), le16(0x4d40), 0xa1, 0x6a, {                                                        \
      0xbf, 0xd5, 0x01, 0x79, 0xd6, 0xac                                                                               \
    }                                                                                                                  \
  }
#define GPT_ENT_TYPE_MS_RESERVED                                                                                       \
  (const efi_guid_t) {                                                                                                 \
    le32(0xe3c9e316), le16(0x0b5c), le16(0x4db8), 0x81, 0x7d, {                                                        \
      0xf9, 0x2d, 0xf0, 0x02, 0x15, 0xae                                                                               \
    }                                                                                                                  \
  }
#define GPT_ENT_TYPE_MS_SPACES                                                                                         \
  (const efi_guid_t) {                                                                                                 \
    le32(0xe75caf8f), le16(0xf680), le16(0x4cee), 0xaf, 0xa3, {                                                        \
...
#define GPT_ENT_TYPE_LINUX_DATA                                                                                        \
  (const efi_guid_t) {                                                                                                 \
    le32(0x0fc63daf), le16(0x8483), le16(0x4772), 0x8e, 0x79, {                                                        \
      0x3d, 0x69, 0xd8, 0x47, 0x7d, 0xe4                                                                               \
    }                                                                                                                  \
  }
#define GPT_ENT_TYPE_LINUX_HOME                                                                                        \
  (const efi_guid_t) {                                                                                                 \
    le32(0x933ac7e1), le16(0x2eb4), le16(0x4f13), 0xb8, 0x44, {                                                        \
      0x0e, 0x14, 0xe2, 0xae, 0xf9, 0x15                                                                               \
    }                                                                                                                  \
  }
#define GPT_ENT_TYPE_LINUX_LVM                                                                                         \
  (const efi_guid_t) {                                                                                                 \
    le32(0xe6d6d379), le16(0xf507), le16(0x44c2), 0xa2, 0x3c, {                                                        \
      0x23, 0x8f, 0x2a, 0x3d, 0xf9, 0x28                                                                               \
    }                                                                                                                  \
  }
#define GPT_ENT_TYPE_LINUX_RAID                                                                                        \
  (const efi_guid_t) {                                                                                                 \
    le32(0xa19d880f), le16(0x05fc), le16(0x4d3b), 0xa0, 0x06, {                                                        \
      0x74, 0x3f, 0x0f, 0x84, 0x91, 0x1e                                                                               \
    }                                                                                                                  \
  }
#define GPT_ENT_TYPE_LINUX_RESERVED                                                                                    \
  (const efi_guid_t) {                                                                                                 \
    le32(0x8da63339), le16(0x0007), le16(0x60c0), 0xc4, 0x36, {                                                        \
      0x08, 0x3a, 0xc8, 0x23, 0x09, 0x08                                                                               \
    }                                                                                                                  \
  }
#define GPT_ENT_TYPE_LINUX_SRV                                                                                         \
  (const efi_guid_t) {                                                                                                 \
    le32(0x3b8f8425), le16(0x20e0), le16(0x4f3b), 0x90, 0x7f, {                                                        \
      0x1a, 0x25, 0xa7, 0x6f, 0x98, 0xe8                                                                               \
    }                                                                                                                  \
  }
#define GPT_ENT_TYPE_LINUX_SWAP                                                                                        \
  (const efi_guid_t) {                                                                                                 \
    le32(0x0657fd6d), le16(0xa4ab), le16(0x43c4), 0x84, 0xe5, {                                                        \
...
#define GPT_ENT_TYPE_HPUX_DATA                                                                                         \
  (const efi_guid_t) {                                                                                                 \
    le32(0x75894c1e), le16(0x3aeb), le16(0x11d3), 0xb7, 0xc1, {                                                        \
      0x7b, 0x03, 0xa0, 0x00, 0x00, 0x00                                                                               \
    }                                                                                                                  \
  }
#define GPT_ENT_TYPE_HPUX_SERVICE                                                                                      \
  (const efi_guid_t) {                                                                                                 \
    le32(0xe2a1e728), le16(0x32e3), le16(0x11d6), 0xa6, 0x82, {                                                        \
      0x7b, 0x03, 0xa0, 0x00, 0x00, 0x00                                                                               \
    }                                                                                                                  \
  }
...
#define GPT_ENT_TYPE_APPLE_CORE_STORAGE                                                                                \
  (const efi_guid_t) {                                                                                                 \
    le32(0x53746F72), le16(0x6167), le16(0x11aa), 0xaa, 0x11, {                                                        \
      0x00, 0x30, 0x65, 0x43, 0xec, 0xac                                                                               \
    }                                                                                                                  \
  }
#define GPT_ENT_TYPE_MAC_APFS                                                                                          \
  (const efi_guid_t) {                                                                                                 \
    le32(0x7c3457ef), le16(0x0000), le16(0x11aa), 0xaa, 0x11, {                                                        \
      0x00, 0x30, 0x65, 0x43, 0xec, 0xac                                                                               \
    }                                                                                                                  \
  }
#define GPT_ENT_TYPE_MAC_BOOT                                                                                          \
  (const efi_guid_t) {                                                                                                 \
    le32(0x426f6f74), le16(0x0000), le16(0x11aa), 0xaa, 0x11, {                                                        \
      0x00, 0x30, 0x65, 0x43, 0xec, 0xac                                                                               \
    }                                                                                                                  \
  }
#define GPT_ENT_TYPE_MAC_HFS                                                                                           \
  (const efi_guid_t) {                                                                                                 \
    le32(0x48465300), le16(0x0000), le16(0x11aa), 0xaa, 0x11, {                                                        \
      0x00, 0x30, 0x65, 0x43, 0xec, 0xac                                                                               \
    }                                                                                                                  \
  }
#define GPT_ENT_TYPE_MAC_LABEL                                                                                         \
  (const efi_guid_t) {                                                                                                 \
    le32(0x4c616265), le16(0x6c00), le16(0x11aa), 0xaa, 0x11, {                                                        \
      0x00, 0x30, 0x65, 0x43, 0xec, 0xac                                                                               \
    }                                                                                                                  \
  }
#define GPT_ENT_TYPE_MAC_RAID                                                                                          \
  (const efi_guid_t) {                                                                                                 \
    le32(0x52414944), le16(0x0000), le16(0x11aa), 0xaa, 0x11, {                                                        \
      0x00, 0x30, 0x65, 0x43, 0xec, 0xac                                                                               \
    }                                                                                                                  \
  }
#define GPT_ENT_TYPE_MAC_RAID_OFFLINE                                                                                  \
  (const efi_guid_t) {                                                                                                 \
    le32(0x52414944), le16(0x5f4f), le16(0x11aa), 0xaa, 0x11, {                                                        \
      0x00, 0x30, 0x65, 0x43, 0xec, 0xac                                                                               \
    }                                                                                                                  \
  }
#define GPT_ENT_TYPE_MAC_TV_RECOVERY                                                                                   \
  (const efi_guid_t) {                                                                                                 \
    le32(0x5265636f), le16(0x7665), le16(0x11aa), 0xaa, 0x11, {                                                        \
      0x00, 0x30, 0x65, 0x43, 0xec, 0xac                                                                               \
    }                                                                                                                  \
  }
#define GPT_ENT_TYPE_MAC_UFS                                                                                           \
  (const efi_guid_t) {                                                                                                 \
    le32(0x55465300), le16(0x0000), le16(0x11aa), 0xaa, 0x11, {                                                        \
      0x00, 0x30, 0x65, 0x43, 0xec, 0xac                                                                               \
    }                                                                                                                  \
  }
...
#define GPT_ENT_TYPE_SOLARIS_BACKUP                                                                                    \
  (const efi_guid_t) {                                                                                                 \
    le32(0x6a8b642b), le16(0x1dd2), le16(0x11b2), 0x99, 0xa6, {                                                        \
      0x08, 0x00, 0x20, 0x73, 0x66, 0x31                                                                               \
    }                                                                                                                  \
  }
#define GPT_ENT_TYPE_SOLARIS_BOOT                                                                                      \
  (const efi_guid_t) {                                                                                                 \
    le32(0x6a82cb45), le16(0x1dd2), le16(0x11b2), 0x99, 0xa6, {                                                        \
      0x08, 0x00, 0x20, 0x73, 0x66, 0x31                                                                               \
    }                                                                                                                  \
  }
#define GPT_ENT_TYPE_SOLARIS_ROOT                                                                                      \
  (const efi_guid_t) {                                                                                                 \
    le32(0x6a85cf4d), le16(0x1dd2), le16(0x11b2), 0x99, 0xa6, {                                                        \
      0x08, 0x00, 0x20, 0x73, 0x66, 0x31                                                                               \
    }                                                                                                                  \
  }
#define GPT_ENT_TYPE_SOLARIS_SWAP                                                                                      \
  (const efi_guid_t) {                                                                                                 \
    le32(0x6a87c46f), le16(0x1dd2), le16(0x11b2), 0x99, 0xa6, {                                                        \
      0x08, 0x00, 0x20, 0x73, 0x66, 0x31                                                                               \
    }                                                                                                                  \
  }
#define GPT_ENT_TYPE_SOLARIS_USR                                                                                       \
  (const efi_guid_t) {                                                                                                 \
    le32(0x6a898cc3), le16(0x1dd2), le16(0x11b2), 0x99, 0xa6, {                                                        \
      0x08, 0x00, 0x20, 0x73, 0x66, 0x31                                                                               \
    }                                                                                                                  \
  }
...
#define GPT_ENT_TYPE_SOLARIS_VAR                                                                                       \
  (const efi_guid_t) {                                                                                                 \
    le32(0x6a8ef2e9), le16(0x1dd2), le16(0x11b2), 0x99, 0xa6, {                                                        \
      0x08, 0x00, 0x20, 0x73, 0x66, 0x31                                                                               \
    }                                                                                                                  \
  }
#define GPT_ENT_TYPE_SOLARIS_HOME                                                                                      \
  (const efi_guid_t) {                                                                                                 \
    le32(0x6a90ba39), le16(0x1dd2), le16(0x11b2), 0x96, 0xa6, {                                                        \
      0x08, 0x00, 0x20, 0x73, 0x66, 0x31                                                                               \
    }                                                                                                                  \
  }
#define GPT_ENT_TYPE_SOLARIS_EFI_ALTSCTR                                                                               \
  (const efi_guid_t) {                                                                                                 \
    le32(0x6a9283a5), le16(0x1dd2), le16(0x11b2), 0x96, 0xa6, {                                                        \
      0x08, 0x00, 0x20, 0x73, 0x66, 0x31                                                                               \
    }                                                                                                                  \
  }
#define GPT_ENT_TYPE_SOLARIS_RESERVED1                                                                                 \
  (const efi_guid_t) {                                                                                                 \
    le32(0x6a945a3b), le16(0x1dd2), le16(0x11b2), 0x96, 0xa6, {                                                        \
      0x08, 0x00, 0x20, 0x73, 0x66, 0x31                                                                               \
    }                                                                                                                  \
  }
#define GPT_ENT_TYPE_SOLARIS_RESERVED2                                                                                 \
  (const efi_guid_t) {                                                                                                 \
    le32(0x6a9630d1), le16(0x1dd2), le16(0x11b2), 0x96, 0xa6, {                                                        \
      0x08, 0x00, 0x20, 0x73, 0x66, 0x31                                                                               \
    }                                                                                                                  \
  }
#define GPT_ENT_TYPE_SOLARIS_RESERVED3                                                                                 \
  (const efi_guid_t) {                                                                                                 \
    le32(0x6a980767), le16(0x1dd2), le16(0x11b2), 0x96, 0xa6, {                                                        \
      0x08, 0x00, 0x20, 0x73, 0x66, 0x31                                                                               \
    }                                                                                                                  \
  }
#define GPT_ENT_TYPE_SOLARIS_RESERVED4                                                                                 \
  (const efi_guid_t) {                                                                                                 \
    le32(0x6a96237f), le16(0x1dd2), le16(0x11b2), 0x96, 0xa6, {                                                        \
      0x08, 0x00, 0x20, 0x73, 0x66, 0x31                                                                               \
    }                                                                                                                  \
  }
#define GPT_ENT_TYPE_SOLARIS_RESERVED5                                                                                 \
  (const efi_guid_t) {                                                                                                 \
    le32(0x6a8d2ac7), le16(0x1dd2), le16(0x11b2), 0x96, 0xa6, {                                                        \
      0x08, 0x00, 0x20, 0x73, 0x66, 0x31                                                                               \
    }                                                                                                                  \
  }
...
#define GPT_ENT_TYPE_BEOS_BFS                                                                                          \
  (const efi_guid_t) {                                                                                                 \
    le32(0x42465331), le16(0x3ba3), le16(0x10f1), 0x80, 0x2a, {                                                        \

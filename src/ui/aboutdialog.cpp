...
void AboutDialog::setupUi() {
  ...
  QLabel *line1 = new QLabel(tr("Derived from PhotoRec by Christophe GRENIER\n"
                                "Qt6 port and extensions by Sinan Islekdemir"),
                             this);
  ...
  QLabel *line3 = new QLabel(tr("• Qt6 graphical interface with Nord dark theme\n"
...
void AboutDialog::applyTheme() {
  setStyleSheet(QString("AboutDialog { background-color: #2E3440; }"
                        "QLabel { color: #ECEFF4; }"
                        "QPushButton {"

...
void LUKSPasswordDialog::setupUi() {
  ...
  m_infoLabel->setText(tr("This partition is encrypted with LUKS.\n"
  ...
  connect(m_showPwdBtn, &QPushButton::toggled, this,
          [this](bool checked) { m_passwordEdit->setEchoMode(checked ? QLineEdit::Normal : QLineEdit::Password); });
}

void LUKSPasswordDialog::applyTheme() {
  setStyleSheet(QString("LUKSPasswordDialog {"

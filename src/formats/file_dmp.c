...
const file_hint_t file_hint_dmp = {.extension = "dmp",
...
static int header_check_dmp(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_dmp(file_stat_t *file_stat) {
  static const unsigned char dmp_header[11] = {0x03, 0x00, 0x01, 'E', 'X', 'P', 'O', 'R', 'T', ':', 'V'};

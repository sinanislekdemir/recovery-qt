...
const file_hint_t file_hint_mysql = {.extension = "MYI",
...
static int header_check_myisam(const unsigned char *buffer, const unsigned int buffer_size,
...
static int header_check_mysql(const unsigned char *buffer, const unsigned int buffer_size,
                              const unsigned int safe_header_only, const file_recovery_t *file_recovery,
                              file_recovery_t *file_recovery_new) {

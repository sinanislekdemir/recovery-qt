...
const file_hint_t file_hint_ds_store = {.extension = "DS_Store",
...
static int header_check_ds_store(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_ds_store(file_stat_t *file_stat) {
  static const unsigned char ds_store_header[8] = {0x00, 0x00, 0x00, 0x01, 'B', 'u', 'd', '1'};

...
const file_hint_t file_hint_sig = {.extension = "custom",
...
static signature_t signatures = {.list = TD_LIST_HEAD_INIT(signatures.list)};
...
static void signature_insert(const char *ext, const unsigned int ext_size, const unsigned int offset, const void *sig,
                             const unsigned int sig_size) {
...
static int header_check_sig(const unsigned char *buffer, const unsigned int buffer_size,

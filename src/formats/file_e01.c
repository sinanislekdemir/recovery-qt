...
const file_hint_t file_hint_e01 = {.extension = "e01",
                                   .description = "Encase",
...
static void file_check_e01(file_recovery_t *file_recovery) {
  ...
  const unsigned char sig_done[16] = {'d',  'o',  'n',  'e',  0x00, 0x00, 0x00, 0x00,
                                      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
  const unsigned char sig_next[16] = {'n',  'e',  'x',  't',  0x00, 0x00, 0x00, 0x00,
                                      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
...
static int header_check_e01(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_e01(file_stat_t *file_stat) {
  static const unsigned char e01_header[9] = {'E', 'V', 'F', 0x09, 0x0d, 0x0a, 0xff, 0x00, 0x01};

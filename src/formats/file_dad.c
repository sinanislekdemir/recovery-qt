...
const file_hint_t file_hint_dad = {.extension = "dad",
...
static data_check_t data_check_dad(const unsigned char *buffer, const unsigned int buffer_size,
...
static int header_check_dad(const unsigned char *buffer, const unsigned int buffer_size,

...
const file_hint_t file_hint_x4a = {.extension = "x4a",
...
static int header_check_ysfc100(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_ysfc100(file_stat_t *file_stat) {
  static const unsigned char ysfc100_header[8] = {'Y', 'S', 'F', 'C', 0xff, 0xff, 0xff, 0xff};

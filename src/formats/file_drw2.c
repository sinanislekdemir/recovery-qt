...
const file_hint_t file_hint_drw2 = {.extension = "drw",
...
static int header_check_drw2(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_drw2(file_stat_t *file_stat) {
  static const unsigned char drw2_header[10] = {0x01, 0xff, 0x02, 0x04, 0x03, 0x02, 0x00, 0x02, 0x02, 0x02};

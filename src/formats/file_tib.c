...
const file_hint_t file_hint_tib = {.extension = "tib",
...
static data_check_t data_check_tib2(const unsigned char *buffer, const unsigned int buffer_size,
...
static int header_check_tib(const unsigned char *buffer, const unsigned int buffer_size,
...
static int header_check_tib2(const unsigned char *buffer, const unsigned int buffer_size,
                             const unsigned int safe_header_only, const file_recovery_t *file_recovery,
                             file_recovery_t *file_recovery_new) {
  reset_file_recovery(file_recovery_new);
  file_recovery_new->extension = file_hint_tib.extension;

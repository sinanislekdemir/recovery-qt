...
const file_hint_t file_hint_fp5 = {.extension = "fp5",
...
static int header_check_fp5(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_fp5(file_stat_t *file_stat) {
  static const unsigned char fp5_header[0x10] = {0x00, 0x01, 0x00, 0x00, 0x00, 0x02, 0x00, 0x01,

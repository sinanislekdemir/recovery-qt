...
const file_hint_t file_hint_bac = {.extension = "bac",
...
static data_check_t data_check_bac(const unsigned char *buffer, const unsigned int buffer_size,
...
static int header_check_bac(const unsigned char *buffer, const unsigned int buffer_size,

...
const file_hint_t file_hint_xml = {.extension = "xml",
...
static void register_header_check_xml(file_stat_t *file_stat) {
  static const unsigned char xml_header[142] = {
      0x3c, 0x00, 0x3f, 0x00, 'x',  0x00, 'm',  0x00, 'l',  0x00, ' ',  0x00, 'v',  0x00, 'e', 0x00, 'r',  0x00,
      's',  0x00, 'i',  0x00, 'o',  0x00, 'n',  0x00, 0x3d, 0x00, 0x22, 0x00, '1',  0x00, '.', 0x00, '0',  0x00,
      0x22, 0x00, ' ',  0x00, 'e',  0x00, 'n',  0x00, 'c',  0x00, 'o',  0x00, 'd',  0x00, 'i', 0x00, 'n',  0x00,
      'g',  0x00, 0x3d, 0x00, 0x22, 0x00, 'U',  0x00, 'T',  0x00, 'F',  0x00, 0x2d, 0x00, '1', 0x00, '6',  0x00,
      0x22, 0x00, 0x3f, 0x00, 0x3e, 0x00, 0x3c, 0x00, 0x21, 0x00, 0x2d, 0x00, 0x2d, 0x00, 'G', 0x00, 'E',  0x00,
      'T',  0x00, 'R',  0x00, 'S',  0x00, 'F',  0x00, 'i',  0x00, 'l',  0x00, 'e',  0x00, 'H', 0x00, 'e',  0x00,
      'a',  0x00, 'd',  0x00, 'e',  0x00, 'r',  0x00, 'S',  0x00, 'i',  0x00, 'z',  0x00, 'e', 0x00, 0x3d, 0x00,
      '0',  0x00, 'x',  0x00, '0',  0x00, '0',  0x00, '0',  0x00, '0',  0x00, '0',  0x00, '8', 0x00};

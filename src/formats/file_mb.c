...
const file_hint_t file_hint_mb = {.extension = "mb",
                                  .description = "Maya",
...
static int header_check_mb(const unsigned char *buffer, const unsigned int buffer_size,
...
static int header_check_mp(const unsigned char *buffer, const unsigned int buffer_size,
                           const unsigned int safe_header_only, const file_recovery_t *file_recovery,
                           file_recovery_t *file_recovery_new) {

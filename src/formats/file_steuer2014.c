...
const file_hint_t file_hint_steuer2014 = {.extension = "steuer2014",
...
static int header_check_steuer(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_steuer(file_stat_t *file_stat) {
  static const unsigned char steuer_header[8] = {'R', 0x26, 'S', 0x1a, 0x11, 0x01, 0x01, 0x00};

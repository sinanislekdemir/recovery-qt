...
const file_hint_t file_hint_dir = {.extension = "fat",
...
static data_check_t data_check_fatdir(const unsigned char *buffer, const unsigned int buffer_size,
...
static int header_check_dir(const unsigned char *buffer, const unsigned int buffer_size,

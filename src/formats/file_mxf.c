...
const file_hint_t file_hint_mxf = {.extension = "mxf",
...
static data_check_t data_check_mxf(const unsigned char *buffer, const unsigned int buffer_size,
...
static int header_check_mxf(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_mxf(file_stat_t *file_stat) {
  static const unsigned char mxf_header[11] = {0x06, 0x0e, 0x2b, 0x34, 0x02, 0x05, 0x01, 0x01, 0x0d, 0x01, 0x02};

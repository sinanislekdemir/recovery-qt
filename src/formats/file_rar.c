...
const file_hint_t file_hint_rar = {.extension = "rar",
...
static int header_check_rar15fmt(const unsigned char *buffer, const unsigned int buffer_size,
...
static int header_check_rar50fmt(const unsigned char *buffer, const unsigned int buffer_size,
                                 const unsigned int safe_header_only, const file_recovery_t *file_recovery,
                                 file_recovery_t *file_recovery_new) {
  reset_file_recovery(file_recovery_new);

...
const file_hint_t file_hint_zcode = {.extension = "zcode",
...
static int header_check_zcode(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_zcode(file_stat_t *file_stat) {
  static const unsigned char zcode_header[8] = {'Z', 'C', 'o', 'd', 'e', 0x00, 0x00, 0x00};

...
const file_hint_t file_hint_luks = {.extension = "luks",
...
static int header_check_luks(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_luks(file_stat_t *file_stat) {
  static const unsigned char luks_header[6] = {'L', 'U', 'K', 'S', 0xba, 0xbe};

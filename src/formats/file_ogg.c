...
const file_hint_t file_hint_ogg = {.extension = "ogg",
...
static data_check_t data_check_ogg(const unsigned char *buffer, const unsigned int buffer_size,
...
static int header_check_ogg(const unsigned char *buffer, const unsigned int buffer_size,
  ...
  if ((buffer[5] & 0x02) != 0x02 && file_recovery->file_stat != NULL && file_recovery->file_check != NULL &&

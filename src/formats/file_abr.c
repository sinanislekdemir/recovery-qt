...
const file_hint_t file_hint_abr = {.extension = "abr",
...
static data_check_t data_check_abr(const unsigned char *buffer, const unsigned int buffer_size,
...
static int header_check_abr(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_abr(file_stat_t *file_stat) {
  static const unsigned char abr_header[11] = {0x00, 0x02, '8', 'B', 'I', 'M', 's', 'a', 'm', 'p', 0x00};

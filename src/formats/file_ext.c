...
const file_hint_t file_hint_ext2_sb = {.extension = "ext",
...
static void file_rename_ext(file_recovery_t *file_recovery) {
  ...
  block_nr = (unsigned long int)le32(sb->s_first_data_block) +
             (unsigned long int)le16(sb->s_block_group_nr) * le32(sb->s_blocks_per_group);
...
static data_check_t data_check_extdir(const unsigned char *buffer, const unsigned int buffer_size,
...
static int header_check_ext2_dir(const unsigned char *buffer, const unsigned int buffer_size,
                                 const unsigned int safe_header_only, const file_recovery_t *file_recovery,
                                 file_recovery_t *file_recovery_new) {

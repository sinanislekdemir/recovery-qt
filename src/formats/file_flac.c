...
const file_hint_t file_hint_flac = {.extension = "flac",
...
static data_check_t data_check_flac_metadata(const unsigned char *buffer, const unsigned int buffer_size,
...
static int header_check_flac(const unsigned char *buffer, const unsigned int buffer_size,

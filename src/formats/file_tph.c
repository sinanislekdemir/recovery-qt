...
const file_hint_t file_hint_tph = {.extension = "tph",
...
static void file_check_tph(file_recovery_t *file_recovery) {
  const unsigned char tph_footer[11] = {'#', 'E', 'N', 'D', '_', 'O', 'F', '_', 'U', 'G', 'C'};
  file_search_footer(file_recovery, tph_footer, sizeof(tph_footer), 1);
}

static int header_check_tph(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_tph(file_stat_t *file_stat) {
  static const unsigned char tph_header[20] = {'#', 'U', 'G', 'C', ':', '2', ' ', 'M', 'F', 'G',
                                               '_', 'T', 'O', 'O', 'L', '_', 'P', 'A', 'T', 'H'};

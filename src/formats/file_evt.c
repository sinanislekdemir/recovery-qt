...
const file_hint_t file_hint_evt = {.extension = "evt",
...
static data_check_t data_check_evt(const unsigned char *buffer, const unsigned int buffer_size,
...
static int header_check_evt(const unsigned char *buffer, const unsigned int buffer_size,

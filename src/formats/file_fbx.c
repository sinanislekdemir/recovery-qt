...
const file_hint_t file_hint_fbx = {.extension = "fbx",
...
static void file_check_fbx(file_recovery_t *file_recovery) {
  const unsigned char fbx_footer[11] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
  file_search_footer(file_recovery, fbx_footer, sizeof(fbx_footer), 237);
}

static int header_check_fbx(const unsigned char *buffer, const unsigned int buffer_size,

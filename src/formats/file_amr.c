...
const file_hint_t file_hint_amr = {.extension = "amr",
...
static data_check_t data_check_amr(const unsigned char *buffer, const unsigned int buffer_size,
  ...
  while (file_recovery->calculated_file_size + buffer_size / 2 >= file_recovery->file_size &&
    ...
    case 0:
      file_recovery->calculated_file_size += 13;
      break;
    case 1:
      file_recovery->calculated_file_size += 14;
      break;
    case 2:
      file_recovery->calculated_file_size += 16;
      break;
    case 3:
      file_recovery->calculated_file_size += 18;
      break;
    case 4:
      file_recovery->calculated_file_size += 20;
      break;
    case 5:
      file_recovery->calculated_file_size += 21;
      break;
    case 6:
      file_recovery->calculated_file_size += 27;
      break;
    default:
      file_recovery->calculated_file_size += 32;
      break;
    }
  }
  return DC_CONTINUE;
...
static int header_check_amr(const unsigned char *buffer, const unsigned int buffer_size,

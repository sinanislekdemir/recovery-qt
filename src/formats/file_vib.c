...
const file_hint_t file_hint_vib = {.extension = "vib",
...
static int header_check_vib(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_vib(file_stat_t *file_stat) {
  static const unsigned char vib_header[12] = {0x01, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 'm', 'd', '5', 0x00};

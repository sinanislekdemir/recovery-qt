...
const file_hint_t file_hint_iso = {.extension = "iso",
                                   .description = "ISO",
...
static int header_check_iso(const unsigned char *buffer, const unsigned int buffer_size,
    ...
    return 0;
  {
    ...
    if (volume_space_size_le == volume_space_size_be && logical_block_size_le == logical_block_size_be) { /* ISO 9660 */

...
const file_hint_t file_hint_d2s = {.extension = "d2s",
...
static int header_check_d2s(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_d2s(file_stat_t *file_stat) {
  static const unsigned char d2s_header[8] = {0x55, 0xaa, 0x55, 0xaa, 0x60, 0x00, 0x00, 0x00};

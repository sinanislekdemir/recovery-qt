...
const file_hint_t file_hint_asl = {.extension = "asl",
...
static int header_check_asl(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_asl(file_stat_t *file_stat) {
  static const unsigned char asl_header[9] = {0x00, 0x02, '8', 'B', 'S', 'L', 0x00, 0x03, 0x00};

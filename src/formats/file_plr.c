...
const file_hint_t file_hint_plr = {.extension = "plr",
...
static int header_check_plr(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_plr(file_stat_t *file_stat) {
  static const unsigned char plr_header[16] = {0x0f, 'w', 'g',  0xfe, 0xb1, 'J',  0xb2, 0xef,

...
const file_hint_t file_hint_DB = {.extension = "DB",
                                  .description = "",
...
static int header_check_DB(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_DB(file_stat_t *file_stat) {
  static const unsigned char DB_header[6] = {0x19, 0x01, 0x00, 0x08, 0x02, 0x20};

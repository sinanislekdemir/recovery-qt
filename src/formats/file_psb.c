...
const file_hint_t file_hint_psb = {.extension = "psb",
...
static data_check_t psb_skip_image_data(const unsigned char *buffer, const unsigned int buffer_size,
...
static data_check_t psb_skip_layer_info(const unsigned char *buffer, const unsigned int buffer_size,
                                        file_recovery_t *file_recovery) {
...
static data_check_t psb_skip_image_resources(const unsigned char *buffer, const unsigned int buffer_size,
                                             file_recovery_t *file_recovery) {
  if (file_recovery->calculated_file_size + buffer_size / 2 >= file_recovery->file_size &&
...
static data_check_t psb_skip_color_mode(const unsigned char *buffer, const unsigned int buffer_size,
                                        file_recovery_t *file_recovery) {
  ...
  if (channels == 0 || channels > 56 || height == 0 || height > 300000 || width == 0 || width > 300000 ||
...
static int header_check_psb(const unsigned char *buffer, const unsigned int buffer_size,

...
const file_hint_t file_hint_apple = {.extension = "apple",
...
static int header_check_apple(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_apple(file_stat_t *file_stat) {
  static const unsigned char apple_header[8] = {0x00, 0x05, 0x16, 0x07, 0x00, 0x02, 0x00, 0x00};

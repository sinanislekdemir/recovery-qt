...
const file_hint_t file_hint_sdw = {.extension = "sdw",
...
static int header_check_sdw(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_sdw(file_stat_t *file_stat) {
  static const unsigned char sdw_header[0x14] = {0x00, 0x01, 0x00, 0x00, 'J', 'e', 't', ' ', 'S', 'y',
                                                 's',  't',  'e',  'm',  ' ', 'D', 'B', ' ', ' ', 0x00};

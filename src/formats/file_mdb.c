...
const file_hint_t file_hint_mdb = {.extension = "mdb",
...
const file_hint_t file_hint_accdb = {.extension = "accdb",
                                     .description = "Access Data Base",
                                     .max_filesize = PHOTOREC_MAX_FILE_SIZE,
                                     .recover = 1,
                                     .enable_by_default = 1,
...
static int header_check_accdb(const unsigned char *buffer, const unsigned int buffer_size,
...
static int header_check_mdb(const unsigned char *buffer, const unsigned int buffer_size,
                            const unsigned int safe_header_only, const file_recovery_t *file_recovery,
                            file_recovery_t *file_recovery_new) {
  reset_file_recovery(file_recovery_new);
...
static void register_header_check_mdb(file_stat_t *file_stat) {
  static const unsigned char mdb_header[] = {0x00, 0x01, 0x00, 0x00, 'S', 't', 'a', 'n', 'd', 'a',
                                             'r',  'd',  ' ',  'J',  'e', 't', ' ', 'D', 'B', 0x00};
  register_header_check(0, mdb_header, sizeof(mdb_header), &header_check_mdb, file_stat);
}

static void register_header_check_accdb(file_stat_t *file_stat) {
  static const unsigned char accdb_header[] = {0x00, 0x01, 0x00, 0x00, 'S', 't', 'a', 'n', 'd', 'a',
                                               'r',  'd',  ' ',  'A',  'C', 'E', ' ', 'D', 'B', 0x00};

...
const file_hint_t file_hint_gct = {.extension = "gct",
...
static int header_check_gct(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_gct(file_stat_t *file_stat) {
  static const unsigned char gct_header[9] = {'J', 'L', 'G', 'E', 'N', '2', 'X', 'F', 'I'};

...
const file_hint_t file_hint_tg = {.extension = "tg",
...
static int header_check_tg(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_tg(file_stat_t *file_stat) {
  static const unsigned char tg_header[0x38] = {
      0x1b, 0x00, 'T',  0x00, 'u',  0x00, 'x',  0x00, 'G',  0x00, 'u',  0x00, 'i',  0x00, 't',  0x00, 'a',  0x00, 'r',
      0x00, ' ',  0x00, 'F',  0x00, 'i',  0x00, 'l',  0x00, 'e',  0x00, ' ',  0x00, 'F',  0x00, 'o',  0x00, 'r',  0x00,
      'm',  0x00, 'a',  0x00, 't',  0x00, ' ',  0x00, 0x2d, 0x00, ' ',  0x00, '1',  0x00, '.',  0x00, '2',  0x00,
  };

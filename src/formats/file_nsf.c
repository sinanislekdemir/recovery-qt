...
const file_hint_t file_hint_nsf = {.extension = "nsf",
...
static int header_check_nsf(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_nsf(file_stat_t *file_stat) {
  static const unsigned char nsf_header[6] = {0x1a, 0x00, 0x00, 0x04, 0x00, 0x00};

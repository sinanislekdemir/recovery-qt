...
const file_hint_t file_hint_psp = {.extension = "psp",
...
static data_check_t data_check_psp(const unsigned char *buffer, const unsigned int buffer_size,
...
static int header_check_psp(const unsigned char *buffer, const unsigned int buffer_size,

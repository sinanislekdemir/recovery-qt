...
const file_hint_t file_hint_one = {.extension = "one",
...
static int header_check_one(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_one(file_stat_t *file_stat) {
  static const unsigned char one_header[16] = {0xe4, 0x52, 0x5c, 0x7b, 0x8c, 0xd8, 0xa7, 0x4d,

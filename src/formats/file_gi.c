...
const file_hint_t file_hint_gi = {.extension = "gi",
...
static int header_check_gi(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_gi(file_stat_t *file_stat) {
  static const unsigned char gi_header[12] = {0xda, 0xda, 0xfe, 0xfe, 0x00, 0x06, 0x1c, 0x04, 0x00, 0x04, 0x00, 0x00};

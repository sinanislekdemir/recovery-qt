...
const file_hint_t file_hint_skd = {.extension = "skd",
...
static int header_check_skd(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_skd(file_stat_t *file_stat) {
  static const unsigned char skd_header[29] = {'A',  'u', 't', 'o', 'S', 'k', 'e', 't',  'c',  'h',
                                               0x20, 'd', 'r', 'a', 'w', 'i', 'n', 'g',  0x20, 'd',
                                               'a',  't', 'a', 'b', 'a', 's', 'e', 0x0d, 0x0a};

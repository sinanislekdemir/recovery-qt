...
const file_hint_t file_hint_qkt = {.extension = "qkt",
...
static int header_check_qkt(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_qkt(file_stat_t *file_stat) {
  static const unsigned char qkt_header[8] = {'q', 'k', 't', 'k', 0x00, 0x00, 0x00, 0x08};

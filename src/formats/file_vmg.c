...
const file_hint_t file_hint_vmg = {.extension = "vmg",
...
static void file_check_vmg(file_recovery_t *file_recovery) {
  const unsigned char vmg_footer[0x15] = {0x00, '\n', 0x00, 'E',  0x00, 'N',  0x00, 'D',  0x00, ':', 0x00,
                                          'V',  0x00, 'M',  0x00, 'S',  0x00, 'G',  0x00, '\n', 0x00};
  file_search_footer(file_recovery, vmg_footer, sizeof(vmg_footer), 0);
}

static int header_check_vmg(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_vmg(file_stat_t *file_stat) {
  static const unsigned char vmg_header[0x28] = {
      'B',  0x00, 'E', 0x00, 'G', 0x00, 'I', 0x00, 'N', 0x00, ':', 0x00, 'V', 0x00, 'M', 0x00, 'S', 0x00, 'G', 0x00,
      '\n', 0x00, 'V', 0x00, 'E', 0x00, 'R', 0x00, 'S', 0x00, 'I', 0x00, 'O', 0x00, 'N', 0x00, ':', 0x00, '1', 0x00};

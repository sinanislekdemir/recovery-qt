...
const file_hint_t file_hint_bfa = {.extension = "bfa",
...
static int header_check_bfa(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_bfa(file_stat_t *file_stat) {
  static const unsigned char bfa_header[8] = {0x24, 0x08, 0x19, 0x92, 0x23, 0x00, 0x15, 0x01};

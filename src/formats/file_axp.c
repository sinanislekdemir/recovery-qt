...
const file_hint_t file_hint_axp = {.extension = "axp",
...
const unsigned char axp_footer[34] = {'<', 0, '/', 0, 'V', 0, 'F', 0, 'N', 0, 'G', 0, 'D',  0, 'o',  0, 'c', 0,
                                      'u', 0, 'm', 0, 'e', 0, 'n', 0, 't', 0, '>', 0, 0x0d, 0, 0x0a, 0};

static void file_check_axp(file_recovery_t *file_recovery) {
  file_search_footer(file_recovery, axp_footer, sizeof(axp_footer), 0);
}

static data_check_t data_check_axp(const unsigned char *buffer, const unsigned int buffer_size,
                                   file_recovery_t *file_recovery) {
  unsigned int j;

  for (j = buffer_size / 2 - sizeof(axp_footer); j + sizeof(axp_footer) <= buffer_size; j++) {
...
static int header_check_axp(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_axp(file_stat_t *file_stat) {
  static const unsigned char axp_header[0x70] = {
      0xff, 0xfe, 0x3c, 0x00, 0x3f, 0x00, 'x',  0x00, 'm',  0x00, 'l',  0x00, ' ',  0x00, 'v',  0x00, 'e',  0x00, 'r',
      0x00, 's',  0x00, 'i',  0x00, 'o',  0x00, 'n',  0x00, 0x3d, 0x00, 0x22, 0x00, '1',  0x00, '.',  0x00, '0',  0x00,
      0x22, 0x00, ' ',  0x00, 'e',  0x00, 'n',  0x00, 'c',  0x00, 'o',  0x00, 'd',  0x00, 'i',  0x00, 'n',  0x00, 'g',
      0x00, 0x3d, 0x00, 0x22, 0x00, 'U',  0x00, 'T',  0x00, 'F',  0x00, 0x2d, 0x00, '1',  0x00, '6',  0x00, 0x22, 0x00,
      0x3f, 0x00, 0x3e, 0x00, 0x0d, 0x00, 0x0a, 0x00, 0x3c, 0x00, 'V',  0x00, 'F',  0x00, 'N',  0x00, 'G',  0x00, 'D',
      0x00, 'o',  0x00, 'c',  0x00, 'u',  0x00, 'm',  0x00, 'e',  0x00, 'n',  0x00, 't',  0x00, 0x3e, 0x00,
  };

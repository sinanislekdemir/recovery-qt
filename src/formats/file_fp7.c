...
const file_hint_t file_hint_fp7 = {.extension = "fp7",
...
static int header_check_fp7(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_fp7(file_stat_t *file_stat) {
  static const unsigned char fp7_header[0x14] = {0x00, 0x01, 0x00, 0x00, 0x00, 0x02, 0x00, 0x01, 0x00, 0x05,
                                                 0x00, 0x02, 0x00, 0x02, 0xc0, 'H',  'B',  'A',  'M',  '7'};

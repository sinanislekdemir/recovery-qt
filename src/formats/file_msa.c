...
const file_hint_t file_hint_msa = {.extension = "msa",
                                   .description = "Mensura",
...
static int header_check_msa(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_msa(file_stat_t *file_stat) {
  static const unsigned char msa_header_fb[4] = {0xfb, 0xff, 0xff, 0xff};
  static const unsigned char msa_header_fc[4] = {0xfc, 0xff, 0xff, 0xff};

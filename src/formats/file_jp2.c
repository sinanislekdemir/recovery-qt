...
const file_hint_t file_hint_jp2 = {.extension = "jp2",
...
static int header_check_jp2(const unsigned char *buffer, const unsigned int buffer_size,
                            const unsigned int safe_header_only, const file_recovery_t *file_recovery,
                            file_recovery_t *file_recovery_new) {
  static const unsigned char jp2_sig[12] = {0x00, 0x00, 0x00, 0x0C, 'j', 'P', 0x20, 0x20, 0x0D, 0x0A, 0x87, 0x0A};
...
static int header_check_j2c(const unsigned char *buffer, const unsigned int buffer_size,
                            const unsigned int safe_header_only, const file_recovery_t *file_recovery,
                            file_recovery_t *file_recovery_new) {
...
static void register_header_check_jp2(file_stat_t *file_stat) {
  static const unsigned char jp2_header[12] = {0x00, 0x00, 0x00, 0x0C, 'j', 'P', 0x20, 0x20, 0x0D, 0x0A, 0x87, 0x0A};

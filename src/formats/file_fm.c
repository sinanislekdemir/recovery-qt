...
const file_hint_t file_hint_fm = {.extension = "fm",
...
static int header_check_fm(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_fm(file_stat_t *file_stat) {
  static const unsigned char fm_header[9] = {0x02, 0x01, 'f', 'm', 'f', '.', 0x07, 0x00, 0x00};

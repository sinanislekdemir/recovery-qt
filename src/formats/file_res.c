...
const file_hint_t file_hint_res = {.extension = "res",
...
static int header_check_res(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_res(file_stat_t *file_stat) {
  static const unsigned char MS_res_header[14] = {0x00, 0x00, 0x00, 0x00, 0x20, 0x00, 0x00,
                                                  0x00, 0xFF, 0xFF, 0,    0,    0xFF, 0xFF};

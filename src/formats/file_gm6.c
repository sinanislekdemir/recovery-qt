...
const file_hint_t file_hint_gm6 = {.extension = "gm*",
...
static int header_check_gm81(const unsigned char *buffer, const unsigned int buffer_size,
...
static int header_check_gmk(const unsigned char *buffer, const unsigned int buffer_size,
                            const unsigned int safe_header_only, const file_recovery_t *file_recovery,
                            file_recovery_t *file_recovery_new) {
  reset_file_recovery(file_recovery_new);
...
static int header_check_gm6(const unsigned char *buffer, const unsigned int buffer_size,
                            const unsigned int safe_header_only, const file_recovery_t *file_recovery,
                            file_recovery_t *file_recovery_new) {
  reset_file_recovery(file_recovery_new);
...
static int header_check_gmd(const unsigned char *buffer, const unsigned int buffer_size,
                            const unsigned int safe_header_only, const file_recovery_t *file_recovery,
                            file_recovery_t *file_recovery_new) {
  reset_file_recovery(file_recovery_new);
...
static void register_header_check_gm6(file_stat_t *file_stat) {
  ...
  */
  //Version 8.1 (.gm81)
  static const unsigned char gm81_header[8] = {0x91, 0xd5, 0x12, 0x00, 0x2a, 0x03, 0x00, 0x00};
  //Version 8.0 (.gmk)
  static const unsigned char gm80_header[8] = {0x91, 0xd5, 0x12, 0x00, 0x20, 0x03, 0x00, 0x00};
  //Version 7.0 variant 2 (.gmk)
  static const unsigned char gm72_header[8] = {0x91, 0xd5, 0x12, 0x00, 0xbe, 0x02, 0x00, 0x00};
  //Version 7.0 variant 1 (.gmk)
  static const unsigned char gm71_header[8] = {0x91, 0xd5, 0x12, 0x00, 0xbd, 0x02, 0x00, 0x00};
  //Version 7.0 early variant (.gmk)
  static const unsigned char gm62_header[8] = {0x91, 0xd5, 0x12, 0x00, 0x6c, 0x02, 0x00, 0x00};
  //Version 6.0-6.1 (.gm6)
  static const unsigned char gm60_header[8] = {0x91, 0xd5, 0x12, 0x00, 0x58, 0x02, 0x00, 0x00};
  //Version 5.3 (.gmd)
  static const unsigned char gm53_header[8] = {0x91, 0xd5, 0x12, 0x00, 0x12, 0x02, 0x00, 0x00};
  //Version 5.2 (.gmd)
  static const unsigned char gm52_header[8] = {0x91, 0xd5, 0x12, 0x00, 0x08, 0x02, 0x00, 0x00};
  //Version 5.1 (.gmd)
  static const unsigned char gm51_header[8] = {0x91, 0xd5, 0x12, 0x00, 0xfe, 0x01, 0x00, 0x00};
  //Version 5.0 (.gmd)
  static const unsigned char gm50_header[8] = {0x91, 0xd5, 0x12, 0x00, 0xf4, 0x01, 0x00, 0x00};
  //Version 4.3 (.gmd)
  static const unsigned char gm43_header[8] = {0x91, 0xd5, 0x12, 0x00, 0xae, 0x01, 0x00, 0x00};

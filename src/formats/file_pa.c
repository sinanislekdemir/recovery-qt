...
const file_hint_t file_hint_pa = {.extension = "pa",
...
static int header_check_pa(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_pa(file_stat_t *file_stat) {
  static const unsigned char pa_header[8] = {'P', 'a', 'F', 'i', 'L', 'e', 0x00, 0x04};

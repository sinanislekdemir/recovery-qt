...
const file_hint_t file_hint_vfb = {.extension = "vfb",
                                   .description = "FontLab",
...
static void file_check_vfb(file_recovery_t *file_recovery) {
  const unsigned char vfb_footer[9] = {0x00, 0x05, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00};
  file_search_footer(file_recovery, vfb_footer, sizeof(vfb_footer), 0);
}

static int header_check_vfb(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_vfb(file_stat_t *file_stat) {
  static const unsigned char vfb_header[8] = {0x1a, 'W', 'L', 'F', '1', '0', 0x03, 0x00};

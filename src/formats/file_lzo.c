...
const file_hint_t file_hint_lzo = {.extension = "lzo",
...
static int header_check_lzo(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_lzo(file_stat_t *file_stat) {
  static const unsigned char lzo_header[9] = {0x89, 'L', 'Z', 'O', 0x00, 0x0d, 0x0a, 0x1a, 0x0a};

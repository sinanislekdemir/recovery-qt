...
const file_hint_t file_hint_bvr = {.extension = "bvr",
...
static data_check_t data_check_bvr(const unsigned char *buffer, const unsigned int buffer_size,
...
static int header_check_bvr(const unsigned char *buffer, const unsigned int buffer_size,

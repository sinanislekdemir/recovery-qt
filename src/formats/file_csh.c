...
const file_hint_t file_hint_csh = {.extension = "csh",
...
static int header_check_csh(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_csh(file_stat_t *file_stat) {
  static const unsigned char csh_header[10] = {'c', 'u', 's', 'h', 0x00, 0x00, 0x00, 0x02, 0x00, 0x00};

...
const file_hint_t file_hint_xfi = {.extension = "xfi",
...
static int header_check_xfi(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_xfi(file_stat_t *file_stat) {
  static const unsigned char xfi_header[0x20] = {0x2c, ' ', 'F', 'u', 'e', 'l', ' ', 'A', 'i', 'r', ' ',
                                                 'S',  'p', 'a', 'r', 'k', ' ', 'T', 'e', 'c', 'h', 'n',
                                                 'o',  'l', 'o', 'g', 'i', 'e', 's', ' ', ' ', ' '};

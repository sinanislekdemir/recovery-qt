...
const file_hint_t file_hint_vdj = {.extension = "vdj",
...
static int header_check_vdj(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_vdj(file_stat_t *file_stat) {
  static const unsigned char vdj_header[12] = {'V', 'D', 'J', 0x00, 0x00, 0x00, 0x00, 0x00, 0x24, 0x00, 0x00, 0x00};

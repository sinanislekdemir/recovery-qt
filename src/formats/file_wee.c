...
const file_hint_t file_hint_wee = {.extension = "wee",
                                   .description = "weecast",
...
static void file_check_wee(file_recovery_t *file_recovery) {
  const unsigned char wee_footer[7] = {'W', 'E', 'E', 'X', 0x21, 0x01, 0x00};
  file_search_footer(file_recovery, wee_footer, sizeof(wee_footer), 17);
}

static int header_check_wee(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_wee(file_stat_t *file_stat) {
  static const unsigned char wee_header[7] = {'W', 'E', 'E', 'X', 0x21, 0x01, 0x00};

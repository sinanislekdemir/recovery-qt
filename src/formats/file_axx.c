...
const file_hint_t file_hint_axx = {.extension = "axx",
                                   .description = "AxCrypt",
...
static int header_check_axx(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_axx(file_stat_t *file_stat) {
  ...
  static const unsigned char axx_header[0x15] = {0xc0, 0xb9, 0x07, 0x2e, 0x4f, 0x93, 0xf1, 0x46, 0xa0, 0x15, 0x79,
                                                 0x2c, 0xa1, 0xd9, 0xe8, 0x21, 0x15, 0x00, 0x00, 0x00, 0x02};

...
const file_hint_t file_hint_lit = {.extension = "lit",
...
static int header_check_lit(const unsigned char *buffer, const unsigned int buffer_size,
...
static void register_header_check_lit(file_stat_t *file_stat) {
  static const unsigned char lit_header[12] = {'I', 'T', 'O', 'L', 'I', 'T', 'L', 'S', 0x01, 0x00, 0x00, 0x00};

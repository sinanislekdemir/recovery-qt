...
static QString upartTypeName(upart_type_t type) {
  ...
  case UP_BEOS:
    return QStringLiteral("BeOS");
  case UP_BTRFS:
    return QStringLiteral("Btrfs");
  case UP_CRAMFS:
    return QStringLiteral("CRAMFS");
  case UP_EXFAT:
  ...
  case UP_FATX:
    return QStringLiteral("FATX");
  case UP_FREEBSD:
    return QStringLiteral("FreeBSD");
  case UP_F2FS:
    return QStringLiteral("F2FS");
  case UP_GFS2:
    return QStringLiteral("GFS2");
  case UP_HFS:
  ...
  case UP_HPFS:
    return QStringLiteral("HPFS");
  case UP_ISO:
    return QStringLiteral("ISO 9660");
  case UP_JFS:
    return QStringLiteral("JFS");
  case UP_LINSWAP:
    return QStringLiteral("Linux Swap");
  case UP_LINSWAP2:
    return QStringLiteral("Linux Swap v2");
  case UP_LUKS:
    return QStringLiteral("LUKS");
  case UP_LVM:
    return QStringLiteral("LVM");
  case UP_LVM2:
    return QStringLiteral("LVM2");
  case UP_MD:
    return QStringLiteral("MD RAID");
  case UP_MD1:
    return QStringLiteral("MD RAID 1");
  case UP_NETWARE:
    return QStringLiteral("NetWare");
  case UP_NTFS:
    return QStringLiteral("NTFS");
  case UP_OPENBSD:
    return QStringLiteral("OpenBSD");
  case UP_OS2MB:
    return QStringLiteral("OS/2 Boot");
  case UP_ReFS:
    return QStringLiteral("ReFS");
  case UP_RFS:
    return QStringLiteral("ReiserFS");
  case UP_RFS2:
    return QStringLiteral("ReiserFS v2");
  case UP_RFS3:
    return QStringLiteral("ReiserFS v3");
  case UP_RFS4:
    return QStringLiteral("Reiser4");
  case UP_SUN:
    return QStringLiteral("Sun");
  case UP_SYSV4:
    return QStringLiteral("SysV");
  case UP_UFS:
    return QStringLiteral("UFS");
  case UP_UFS2:
    return QStringLiteral("UFS2");
  case UP_UFS_LE:
    return QStringLiteral("UFS LE");
  case UP_UFS2_LE:
    return QStringLiteral("UFS2 LE");
  case UP_VMFS:
    return QStringLiteral("VMFS");
  case UP_WBFS:
    return QStringLiteral("WBFS");
  case UP_XFS:
    return QStringLiteral("XFS");
  case UP_XFS2:
    return QStringLiteral("XFS2");
  case UP_XFS3:
    return QStringLiteral("XFS3");
  case UP_XFS4:
    return QStringLiteral("XFS4");
  case UP_XFS5:
    return QStringLiteral("XFS5");
  case UP_ZFS:
...
int PartitionList::count() const {
  return m_count;
}
bool PartitionList::isValid() const {
  return m_partList != nullptr;
}
